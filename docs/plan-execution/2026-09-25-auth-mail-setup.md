...
**2026-09-26 후속:** 이 문서의 `Confirm Email` 꺼짐과 실제 가입 미확인 표기는 준비 당시 상태다. 사용자가 이후 이를 켜고 신규 가입부터 앱 복귀까지 시험했으며, 새 계정 1명의 확인 완료를 읽기 전용 DB 집계로 대조했다. [후속 검증 기록](2026-09-26-auth-email-verified.md)
